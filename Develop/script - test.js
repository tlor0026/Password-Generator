...
//for(var i = 0; i < specialNumbers.length; 1++) {
  //console.log(specialNumbers)
  //console.log(i);
  //console.log(specialNumbers[i] + "numbo" + i + 'muno')

var generate = function(specialCharacters)
...
var generatePassword = window.prompt("would you like to randomize a password?")
var specialCharacters = ["!,@,#,%,^,&,*"];
var numbers = ["1,2,3,4,5,6,7,8"]
var letters = ["q,w,e,r,t,y,u,i"]
